...
Binary packages in the [release area](https://github.com/stronnag/fl2xui/releases) for Debian based Linux distros and Windows.

Easily built from source for other Linux, FreeBSD and MacOS. Build instructions in the [user guide](https://stronnag.github.io/fl2xui/).
